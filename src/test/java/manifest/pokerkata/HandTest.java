...
public class HandTest {
	...
	@Test
	public void handShouldHaveRankingOf6ForFullHouseWithThreeOfAKindThenOnePair() {
	...
	@Test
	public void handShouldHaveRankingOf7ForFourOfAKindInFirstFourCards() {
		Card card1 = new Card("3", "H");
		Card card2 = new Card("3", "C");
		Card card3 = new Card("3", "S");
		Card card4 = new Card("3", "D");
	...
	@Test
	public void handShouldHaveRankingOf8ForStraightFlush() {
		Card card1 = new Card("9", "H");
		Card card2 = new Card("8", "H");
